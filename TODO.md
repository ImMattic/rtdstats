...
## Known Fixes
- [ ] Outline the selected vehicle in white to improve visibility against the map background.
...
- [ ] Add Github repo button in the top right corner of the page
- [ ] Don't show vehicles at Union Station (39.7531695197791, -105.00028537059949) until a certain zoom level is reached, since they are often stuck there and clutter the map
...
- [ ] Add padding to the Stuck Vehicle Alert time tag on the row so that the See on Map icon doesn't move when the time changes
