      ...
      <div>
        ...
        <ResponsiveContainer width="100%" height={240}>
          <ComposedChart data={series} margin={{ left: 4, right: 8, top: 8 }}>
            ...
            />
            <Bar dataKey="boardings" fill={theme.seriesFaint} radius={[3, 3, 0, 0]} />
            <Line type="monotone" dataKey="boardings" stroke={theme.series} strokeWidth={2} dot={false} />
          </ComposedChart>
        </ResponsiveContainer>
      </div>
            ...
            {topRoutes.map((r) => {
              ...
              return (
                <div key={r.route_id} className="flex items-center gap-2 text-xs">
                  ...
                  <div className="h-4 flex-1 overflow-hidden rounded bg-card-muted">
                    <div
